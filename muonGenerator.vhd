...
architecture Rtl of muonGenerator is
  ...
  signal arrival_counter : unsigned(19 downto 0) := (others => '0');
  signal arrival_target : unsigned(19 downto 0) := to_unsigned(300000, 20);
...
begin
  ...
  begin
    if Reset = '1' then
      ...
      arrival_target <= to_unsigned(300000, 20);
      pulse_max <= (others => '0');
      pulse_val <= (others => '0');
      ...
      case state is
        ...
        when BASELINE =>
          ...
          if arrival_counter >= arrival_target then
            ...
            -- Randomize next arrival [0,524287] + 200000 => [200000,724287] (~2-7 ms)
            arrival_target <= resize(unsigned(lsfr(18 downto 0)), 20)
                              + to_unsigned(200000, 20);
