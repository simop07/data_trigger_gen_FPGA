...
set_property PACKAGE_PIN L2 [get_ports triggerOut2]
set_property IOSTANDARD LVCMOS33 [get_ports triggerOut2]
...
# ILA (Integrated Logic Analyzer) part -> oscilloscope
...
connect_debug_port u_ila_0/probe0 [get_nets [list in_pulse_loc]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list trg_out_loc]]
